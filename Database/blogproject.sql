...
(47, 'Google April Fool Gmail button sparks backlash', 'Google has removed an April Fool\'s Gmail button, which sent a comical animation to recipients, after reports of people getting into trouble at work.\n', 'google_splash.jpg', '1459435249');
...
(0, 'Portfolioheader', 'acs', 17),
(0, 'Portfoliofooter', 'acs', 23);
...
--
-- Indexes for table `commentstwo`
--
ALTER TABLE `commentstwo`
  ADD PRIMARY KEY (`id`);
...
--
ALTER TABLE `ci_news`
  MODIFY `ne_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=48;
...
--
-- AUTO_INCREMENT for table `commentstwo`
--
ALTER TABLE `commentstwo`
...
--
ALTER TABLE `description`
  MODIFY `description_id` int(100) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=68;
