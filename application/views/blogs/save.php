<div class="container top-margin text-white bg-dark">
    ...
    <?php echo form_open_multipart('blogs/save'); ?>
    ...
    <div class="form-group">
        ...
        <div class="input-group mb-3">
            <div class="custom-file">
                <input type="file" accept="image/png, image/jpeg, image/jpg" name="userfile" class="custom-file-input"
                    id="inputGroupFile02">
...
$(function() {
	...
	// CKEDITOR.plugins.addExternal('widgetselection', '<?php echo base_url('application/assets/ckeditor/plugins/widgetselection/plugin.js');?>');
	// CKEDITOR.plugins.addExternal('N1ED-editor', '<?php echo base_url('application/ckeditor/plugins/N1ED-editor/plugin.js');?>');
