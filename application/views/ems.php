...
<section>
    ...
    <aside id="leftsidebar" class="sidebar">
        ...
        <div class="menu main-sidebar">
            <?php $categories = $this->categories_model->get_published_cat_ems(); ?>
                            ...
                            <div class="comments-box boxpadding">
                                <div class="media">
                                    <div class="media-body">
                                        ...
                                        <?php } ?>
                                        <?php echo form_open_multipart('blogs/ems'); ?>
                                        <form id="createcommentform3">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-light">
        ...
        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
            ...
            <div class="navbar-nav">
                ...
                <a class="nav-item nav-link active" href="<?php echo site_url(); ?>/blogs/ems">EMS</a>
            </div>
        </div>
    </nav>
